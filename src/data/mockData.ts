...
const RAW_AC_DATA = [
  { no: 1, ruangan: 'Ruang Kepsek SMP', merk: 'Gree', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 2, ruangan: 'Ruang UKS SMP', merk: 'Panasonic', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 3, ruangan: 'Ruang BK SMP', merk: 'Panasonic', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 4, ruangan: 'Ruang Musik SMP', merk: 'Daikin', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 5, ruangan: 'Ruang Musik SMP', merk: 'Samsung', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 6, ruangan: 'Ruang Musik SMP', merk: 'TCL', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 7, ruangan: 'Ruang Lab. Komputer', merk: 'Gree', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 8, ruangan: 'Ruang Lab. Komputer', merk: 'Daikin', unitGedung: 'SMP - AL FARABI', unit: 'SMP', gedung: 'Al Farabi' },
  { no: 9, ruangan: 'Ruang Perpustakaan', merk: 'Panasonic', unitGedung: 'IBNU KHALDUN', unit: 'SD', gedung: 'Ibnu Khaldun' },
  { no: 10, ruangan: 'Ruang Perpustakaan', merk: 'Daikin', unitGedung: 'IBNU KHALDUN', unit: 'SD', gedung: 'Ibnu Khaldun' },
  { no: 11, ruangan: 'Ruang Perpustakaan', merk: 'LG', unitGedung: 'IBNU KHALDUN', unit: 'SD', gedung: 'Ibnu Khaldun' },
  { no: 12, ruangan: 'Ruang Audio Visual', merk: 'Daikin', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 13, ruangan: 'Ruang Office Laki - Laki', merk: 'Gree', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 14, ruangan: 'Ruang Pak Gofar', merk: 'Daikin', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 15, ruangan: 'Ruang GA Pak Soleh S.T', merk: 'Gree Lama', unitGedung: 'IBNU KHALDUN', unit: 'General Affair', gedung: 'Ibnu Khaldun' },
  { no: 16, ruangan: 'Ruang GM', merk: 'Gree', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 17, ruangan: 'Ruang Office Perempuan', merk: 'Gree', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 18, ruangan: 'Ruang Deputy GM Bu Andin', merk: 'Daikin', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 19, ruangan: 'Ruang Bu Rahmi', merk: 'Gree', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 20, ruangan: 'Ruang Bu Izar', merk: 'Gree', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 21, ruangan: 'Ruang Bu Yun', merk: 'Daikin', unitGedung: 'IBNU KHALDUN', unit: 'Facility Management', gedung: 'Ibnu Khaldun' },
  { no: 22, ruangan: 'Ruang Musik TK', merk: 'Polytron', unitGedung: 'IBNU KHALDUN', unit: 'TK', gedung: 'Ibnu Khaldun' },
  { no: 23, ruangan: 'Ruang Musik TK', merk: 'Panasonic', unitGedung: 'IBNU KHALDUN', unit: 'TK', gedung: 'Ibnu Khaldun' },
  { no: 24, ruangan: 'Kelas lt 3.1', merk: 'Daikin', unitGedung: 'SD - IBNU RUSYD', unit: 'SD', gedung: 'Ibnu Rusyd' },
  { no: 25, ruangan: 'Kelas lt 3.2', merk: 'Daikin', unitGedung: 'SD - IBNU RUSYD', unit: 'SD', gedung: 'Ibnu Rusyd' },
  { no: 26, ruangan: 'Kelas lt 3.3', merk: 'Daikin', unitGedung: 'SD - IBNU RUSYD', unit: 'SD', gedung: 'Ibnu Rusyd' },
  { no: 27, ruangan: 'Kelas lt 3.4', merk: 'Daikin', unitGedung: 'SD - IBNU RUSYD', unit: 'SD', gedung: 'Ibnu Rusyd' },
  { no: 28, ruangan: 'Ruang Radio', merk: 'Samsung', unitGedung: 'SD - RUANG ANTARA', unit: 'SD', gedung: 'Ibnu Khaldun' },
  { no: 29, ruangan: 'Ruang Bu Sari', merk: 'Denpoo', unitGedung: 'SD - RUANG ANTARA', unit: 'SD', gedung: 'Ibnu Khaldun' },
  { no: 30, ruangan: 'Ruang ex Bu fina', merk: 'Daikin', unitGedung: 'SD - RUANG ANTARA', unit: 'SD', gedung: 'Ibnu Khaldun' },
  { no: 31, ruangan: 'Ruang Lab Komputer', merk: 'Gree', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 32, ruangan: 'Ruang Lab Komputer', merk: 'Gree', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 33, ruangan: 'Ruang Musik SD', merk: 'Gree', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 34, ruangan: 'Ruang Musik SD', merk: 'Gree', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 35, ruangan: 'Kelas lt 2.1', merk: 'Daikin', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 36, ruangan: 'Kelas lt 2.2', merk: 'Daikin', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 37, ruangan: 'Kelas lt 2.3', merk: 'Daikin', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 38, ruangan: 'Kelas lt 2.4', merk: 'Daikin', unitGedung: 'SD AL BIRUNI', unit: 'SD', gedung: 'Al Biruni' },
  { no: 39, ruangan: 'Ruang Day Care 1', merk: 'Daikin', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 40, ruangan: 'Ruang Day Care 2', merk: 'Daikin', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 41, ruangan: 'Ruang Pak Asep', merk: 'Dast', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 42, ruangan: 'Ruang Admin Pelangi', merk: 'LG', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 43, ruangan: 'Ruang Terapi Wicara 1', merk: 'Daikin', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 44, ruangan: 'Ruang Terapi Wicara 2', merk: 'Samsung', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 45, ruangan: 'Ruang Terapi Wicara 3', merk: 'Panasonic', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 46, ruangan: 'Ruang Terapis', merk: 'Polytron', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 47, ruangan: 'Ruang Pelangi SI', merk: 'Daikin', unitGedung: 'PELANGI & DAYCARE', unit: 'Pelangi', gedung: 'Pelangi' },
  { no: 48, ruangan: 'Ruang Informasi', merk: 'Polytron', unitGedung: 'AR RAZI', unit: 'TK', gedung: 'Arrazi' },
  { no: 49, ruangan: 'Ruang Bu Mutia', merk: 'Polytron', unitGedung: 'AR RAZI', unit: 'TK', gedung: 'Arrazi' },
  { no: 50, ruangan: 'Ruang Kasir', merk: 'Panasonic', unitGedung: 'AR RAZI', unit: 'Keuangan', gedung: 'Arrazi' },
  { no: 51, ruangan: 'Ruang Pak Slamet', merk: 'Dast', unitGedung: 'AR RAZI', unit: 'Facility Management', gedung: 'Arrazi' },
  { no: 52, ruangan: 'Ruang Resources', merk: 'Samsung', unitGedung: 'AR RAZI', unit: 'TK', gedung: 'Arrazi' },
  { no: 53, ruangan: 'Ruang Meeting', merk: 'Gree', unitGedung: 'AR RAZI', unit: 'Facility Management', gedung: 'Arrazi' },
  { no: 54, ruangan: 'Ruang Bu Fina', merk: 'Samsung', unitGedung: 'DIREKTORAT', unit: 'Facility Management', gedung: 'Direktorat' },
  { no: 55, ruangan: 'Ruang Admin Tk', merk: 'Dast', unitGedung: 'DIREKTORAT', unit: 'TK', gedung: 'Direktorat' },
  { no: 56, ruangan: 'Ruang Pak Sayyed', merk: 'Samsung', unitGedung: 'DIREKTORAT', unit: 'Facility Management', gedung: 'Direktorat' },
  { no: 57, ruangan: 'Ruang Sekdir', merk: 'Daikin', unitGedung: 'DIREKTORAT', unit: 'Facility Management', gedung: 'Direktorat' },
  { no: 58, ruangan: 'Ruang Pak Kamil', merk: 'Gree', unitGedung: 'DIREKTORAT', unit: 'Facility Management', gedung: 'Direktorat' },
  { no: 59, ruangan: 'Ruang Bu Lubna', merk: 'Gree', unitGedung: 'DIREKTORAT', unit: 'Facility Management', gedung: 'Direktorat' },
];

export const LAZUARDI_AC_ASSETS: Asset[] = RAW_AC_DATA.map((item) => ({
  id: `ast-ac-${item.no}`,
  qrCode: `LZU-AC-${String(item.no).padStart(3, '0')}`,
  assetIdAuto: `LZU-AC-2024-${String(item.no).padStart(3, '0')}`,
  nomorInventaris: `INV/AC/2024/${String(item.no).padStart(3, '0')}`,
  namaAsset: `AC ${item.merk} - ${item.ruangan}`,
  kategori: 'AC',
  subKategori: 'AC Split Wall',
  merk: item.merk,
  tipe: 'Inverter Split Wall',
  model: `AC-${item.merk.replace(/\s+/g, '')}-1PK`,
  unit: item.unit as any,
  departemen: `Unit ${item.unit}`,
  penanggungJawab: 'Alpian Rinaldhi',
  picAsset: 'Alpian Rinaldhi',
  userPengguna: item.ruangan,
  fotoUrl: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=600&auto=format&fit=crop&q=80',
  supplier: 'Vendor AC Lazuardi GCS',
  sumberPengadaan: 'Dibeli oleh Facility Management',
  dibeliOleh: 'Facility Management',
  statusVerifikasi: 'Diverifikasi FM',
  namaUnitPengaju: item.unit,
  ...
  location: {
    unit: item.unit as any,
    gedung: item.gedung as any,
    lantai: 'Lantai 1',
    ruangan: item.ruangan,
    area: item.unitGedung,
    titikLokasi: `${item.ruangan} (${item.unitGedung})`,
  },
  kondisi: 'Baik',
  status: 'Aktif',
  terakhirCuciAC: '2026-05-10',
  jadwalCuciACBerikutnya: '2026-08-10',
  statusCuciAC: 'Siap Pakai / Normal',
  rekomendasiPerbaikan: 'Dingin Normal',
  freonType: 'R32',
  pk: '1 PK',
  acWashHistory: [
    {
      id: `wash-ac-${item.no}`,
      assetId: `ast-ac-${item.no}`,
      tanggalService: '2026-05-10',
      jenisService: 'Cuci Rutin Indoor & Outdoor',
      teknisiName: 'CV Windu Cool Technique (Vendor Luar)',
      isVendorLuar: true,
      kondisiFreon: 'Normal (85-90 Psi)',
      gantiSparepart: false,
      biaya: 90000,
      catatan: 'Cuci filter rutin, kondisi evaporator bersih & embusan dingin optimal.',
    }
  ],
  maintenanceHistory: [],
  damageReports: [],
